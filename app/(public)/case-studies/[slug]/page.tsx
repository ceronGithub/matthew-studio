/**
 * FILE: app/(public)/case-studies/[slug]/page.tsx
 * ROLE: Public — single case study page, served at "/case-studies/[slug]".
 *
 * PURPOSE:
 * Rebrand of the old "/portfolio/[slug]" (improvement_1.md Section 3/5).
...
export async function generateMetadata({ params }: CaseStudyPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title, description: project.tagline, images: ["/og-case-studies.png"] },
  };
}
